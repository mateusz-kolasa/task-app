...
describe('ListTitleTextForm', () => {
  it('renders ListTitleTextForm component', () => {
    customRender(
      <ListTitleTextForm title={list.title} handleClose={handleClose} listId={list.id} />
    )
  })
  ...
  it('Shows error notification on error', async () => {
    ...
    fireEvent.change(getByRole('textbox'), {
      target: { value: 'list new title' },
    })
    fireEvent.blur(getByRole('textbox'))
    await waitFor(() => expect(getByText('list.title.error.title')).toBeTruthy())
  })
})
